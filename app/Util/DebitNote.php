...
class DebitNote {
    ...
    public function generar_xml(){
        ...
        switch($documento->facturacion->tipo_nota_electronica){
            case 01:
                $documento->leyenda_nota = 'Intereses por mora';
                break;
            case 02:
                $documento->leyenda_nota = 'Aumento en el valor';
                break;
            case 03:
                $documento->leyenda_nota = 'Penalidades / otros conceptos';
                break;
        }
        ...
        $view = view('sunat/docs/debitnote',['documento'=>$documento,'usuario'=>$usuario,'items'=>$detalle,'emisor'=>$emisor]);
        return $view->render();
