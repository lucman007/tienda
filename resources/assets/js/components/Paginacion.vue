<template>
    <nav aria-label="Page navigation example">
         <ul class="pagination">
            <li class="page-item" v-if="pagesNumber.length > 1" :class="{'disabled':pagination.current_page == 1}">
            ...
            <li v-if="pagesNumber.length > 1" class="page-item" v-for="page in pagesNumber" :class="{'active': page == pagination.current_page}">
                <a class="page-link" href="javascript:void(0)" v-on:click.prevent="changePage(page)">{{ page }}</a>
            </li>
            <li class="page-item" v-if="pagesNumber.length > 1" :class="{'disabled':pagination.current_page == pagination.last_page}">
