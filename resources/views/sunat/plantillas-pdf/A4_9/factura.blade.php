...
@section('contenido')
    <div class="header">
        <div class="header-ruc">
            <h3 style="">{{mb_strtoupper($documento->titulo_doc)}}<br><span style="font-size: 12.5pt">ELECTRÓNICA</span></h3>
            <h4 style="font-size: 12.7pt">{{$documento->serie}}-{{$documento->correlativo}}</h4>
        </div>
        @if($emisor->logo)
        ...
        <table cellpadding="0">
            ...
            <tr>
                ...
                @if($documento->facturacion->oc_relacionada)
                    <td><strong>Ord. compra:</strong> </td>
        ...
        <table class="items" cellpadding="0">
            ...
            @foreach($items as $item)
                <tr class="items-tr">
                    ...
                    <td style="width: 75mm; text-align: left">{!! $item->descripcion !!} {{$item->detalle->num_serie?'- SERIE PRODUCTO: '.$item->detalle->num_serie:''}}</td>
                ...
                <td class="footer-l">
                    ...
                    @if($documento->tipo_pago == 2)
                        ...
                        <table class="cuotas_table">
                            <thead>
                            <tr><td colspan="3" style="text-align:center; background: #dfdfdf; padding: 5px 0;"><strong>DETALLE DE CUOTAS</strong></td></tr>
                            <tr>
    ...
    <table style="margin-left:20px; margin-top: -20px">
        <tr>
            <td>
                <img style="width: 80px" class="qr" src="images/qr/{{$documento->qr}}">
            </td>
            <td>
