        ...
        <div class="info-emisor">
            ...
            <div class="texto">
                ...
                <p>
                    ...
                    {{$ocultar_razon?'':$emisor->razon_social}}<br>R.U.C. {{$emisor->ruc}}<br>{{$emisor->direccion}}, {{$emisor->urbanizacion==''?'':$emisor->urbanizacion.','}} {{$emisor->provincia}},
            ...
            <table cellpadding="0">
                ...
                @if($documento->num_oc)
                    <tr>
                        ...
                        <td style="width:42mm">{{$documento->num_oc}}</td>
                    </tr>
                @endif
            </table>
        </div>
