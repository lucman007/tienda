        ...
        <table class="items" cellpadding="0">
            ...
            @foreach($items as $item)
                <tr class="items-tr">
                    ...
                    <td style="width: 92mm">{!! $item->descripcion !!}</td>
                ...
                <td class="footer-l">
                    ...
                    @if($documento->tipo_pago == 2)
                        ...
                        <table class="cuotas_table">
                            <thead>
                            <tr><td colspan="3" style="text-align:center; background: #27ae60;"><strong style="color:white">Detalle de cuotas</strong></td></tr>
                            <tr>
