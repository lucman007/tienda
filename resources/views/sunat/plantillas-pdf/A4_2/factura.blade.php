...
@section('contenido')
                ...
                <td class="footer-r">
                    ...
                    @if($documento->facturacion->codigo_tipo_factura == '1001')
                        ...
                        <table>
                            ...
                            <tr>
                                <td><strong>Detracción:</strong> <br> {{$documento->codigo_moneda}} {{$documento->detraccion}} ({{$documento->porcentaje_detraccion}}%)</td>
                            </tr>
                            @if($documento->tipo_pago == 2)
                                <tr>
                                    <td><strong>Monto neto pendiente de pago:</strong><br> {{$documento->codigo_moneda}} {{$documento->monto_menos_detraccion}}</td>
                                </tr>
                            @endif
                        </table>
                    @endif
    ...
    @if($documento->tipo_pago == 2)
        @php
            $i=1
        @endphp
        <table class="cuotas_table" style="margin-top: 4mm">
            <thead>
