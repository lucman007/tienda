...
@section('contenido')
    ...
    <div class="body">
        ...
        <div class="borde info-usuario" style="margin-top: 3mm">
            <table cellpadding="0">
                <tr>
                    <td>ENVÍO:</td>
                </tr>
        ...
        <table class="footer">
            <tr>
                <td class="footer-l">
                    @if($documento->qr)
                        <img style="float: left; margin-top:10px" class="qr" src="images/qr/{{$documento->qr}}">
                    @endif
                    <p style="margin-top:20px">Representación Impresa de la {{$documento->titulo_doc}} Electrónica <br>
