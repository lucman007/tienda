                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <span class="badge" :class="{'badge-warning':estado=='PENDIENTE',
            ...
            <div class="col-lg-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body pt-5">
                        <div v-if="!(estado=='ANULADO' || estado=='RECHAZADO')" class="form-group d-flex justify-content-center">
                            <b-button v-if="estado=='PENDIENTE'" class="mb-2 mr-2" href="/guia/correccion/{{$guia->idguia}}"
                                      variant="primary">
                                <i v-show="!mostrarProgreso" class="fas fa-edit"></i>
                                <b-spinner v-show="mostrarProgreso" small label="Loading..." ></b-spinner> Corregir guía
                            </b-button>
                            <b-button v-if="estado=='PENDIENTE'" class="mb-2 mr-2" @click="consultar_guia('{{$guia->ticket}}','{{$guia->idguia}}')"
                                      variant="success">
                            ...
                            <b-button class="mb-2 mr-2"
                                      ...
                                      target="_blank" :href="'{{url('guia/imprimir').'/'.$guia->idguia.'?formato='}}'+formato"
                                      @else
                            ...
                            <b-button class="mb-2 mr-2"  href="{{url('ventas/descargar').'/'.$guia->idguia.'?guia=true'}}" title="Descargar PDF" variant="warning">
                            ...
                            <b-button class="mb-2 mr-2" href="{{url('ventas/descargar').'/'.$guia->nombre_fichero.'.xml'}}" title="Descargar XML" variant="warning">
    ...
    <script>
        ...
        let app = new Vue({
            ...
            data: {
                ...
                mensaje:'<?php echo str_replace(array("\r", "\n"), '', str_replace('\'', "",$guia->response)) ?>',
                formato:'A4',
            },
            created(){
            ...
            methods: {
                ...
                imprimir(idguia){
                    let src = "/guia/imprimir/"+idguia+"?formato="+this.formato;
                    @if(!$agent->isDesktop())
