@php /** Modelo 09 - habilitado**/@endphp
<!doctype html>
...
<body>
<div class="header" style="border-top: 15px solid #ffca11;">
    <div class="box-header" style="width: 200mm;  height: 18mm; border-bottom:1px solid black; margin-top: 10mm; position: relative">
        <div class="fecha" style="position: absolute; left: 3mm">
            <p style="text-align: left">FECHA: {{ date('d/m/Y',strtotime($presupuesto->fecha)) }} HORA: {{ date('g:i A',strtotime($presupuesto->fecha)) }}</p>
            <p style="font-size: 14px; text-align: left"><strong>Cotización N° {{$presupuesto['correlativo']}}</strong></p>
        </div>
        @if($emisor->logo)
            <div class="logo" style="position: absolute; right:0; width: 250px; top:-10mm">
