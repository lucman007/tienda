...
@section('contenido')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="titulo-admin-1">Nuevo pedido</h3>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <b-button class="mb-2 float-right" @click="limpiar" variant="danger"><i class="fas fa-ban"></i> Cancelar
                                </b-button>
                                <b-button :disabled="mostrarProgresoGuardado || productosSeleccionados.length==0" class="mb-2 float-right mr-3" :disabled="productosSeleccionados.length==0" @click="procesarOrden"
                                          variant="success">
                                    <i v-show="!mostrarProgresoGuardado" class="fas fa-save"></i>
                                    <b-spinner v-show="mostrarProgresoGuardado" small label="Loading..." ></b-spinner> Guardar pedido
                                </b-button>
                            </div>
                        </div>
                    </div>
                    ...
                    axios.post('{{action('PedidoController@store')}}', {
                        ...
                        .then(response => {
                            this.$swal({
                                position: 'center',
                                icon: 'success',
                                title: 'Se ha guardado el pedido',
