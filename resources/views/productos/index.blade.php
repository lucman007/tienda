                        ...
                        <div class="table-responsive tabla-gestionar">
                            <table class="table table-striped table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <th @if(!$columnas['codigo']) style="display: none;" @endif scope="col">
                                        <a href="{{ app('sysfact\Http\Controllers\Helpers\MainHelper')->urlOrdenamiento(request(), 'cod_producto') }}">
                                            Código <span class="icon-hover @if($orderby == 'cod_producto') icon-hover-active @endif">{!! $order_icon !!}</span>
                                        </a>
                                    </th>
                                    ...
                                    <th @if(!$columnas['categoria']) style="display: none;" @endif scope="col">
                                        <a href="{{ app('sysfact\Http\Controllers\Helpers\MainHelper')->urlOrdenamiento(request(), 'categoria') }}">
                                            Categoria <span class="icon-hover @if($orderby == 'categoria') icon-hover-active @endif">{!! $order_icon !!}</span>
                                        </a>
                                    ...
                                    <th @if(!$columnas['precio']) style="display: none;" @endif scope="col">
                                        <a href="{{ app('sysfact\Http\Controllers\Helpers\MainHelper')->urlOrdenamiento(request(), 'precio') }}">
                                            Precio <span class="icon-hover @if($orderby == 'precio') icon-hover-active @endif">{!! $order_icon !!}</span>
                                        </a>
